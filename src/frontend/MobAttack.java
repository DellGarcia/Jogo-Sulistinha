...
public class MobAttack extends JPanel implements ActionListener {
	...
	public MobAttack() {
		...
		this.af = new ArmazenaFrame("skeleton-attack");
	...
	public void iniciarAnimacao() {
		...
		for (int i = 0; i < sizeAnimation; i++) {
			images[i] = new ImageIcon(
					tk.createImage(af.getFrames().get(i).getCaminho()).getScaledInstance(180, 156, Image.SCALE_DEFAULT)
			);
